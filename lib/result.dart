...
class MsalMobileResult {
  ...
  MsalMobileResult.fromJson(Map<String, dynamic> json)
      : isSuccess = json['isSuccess'],
        exception = json['exception'] != null ? MsalMobileException.fromJson((json['exception'] as Map<String, dynamic>)) : null,
        innerException = json['innerException'] != null ? MsalMobileException.fromJson((json['innerException'] as Map<String, dynamic>)) : null;
}
...
class MsalMobileGetAccountResult implements MsalMobileResult {
  ...
  MsalMobileGetAccountResult.fromJson(Map<String, dynamic> json)
      : isSuccess = json['isSuccess'],
        payload = json['payload'] != null ? MsalMobileGetAccountResultPayload.fromJson((json['payload'] as Map<String, dynamic>)) : null,
        exception = json['exception'] != null ? MsalMobileException.fromJson((json['exception'] as Map<String, dynamic>)) : null,
        innerException = json['innerException'] != null ? MsalMobileException.fromJson((json['innerException'] as Map<String, dynamic>)) : null;
}
...
class MsalMobileAuthenticationResult implements MsalMobileResult {
  ...
  MsalMobileAuthenticationResult.fromJson(Map<String, dynamic> json)
      : isSuccess = json['isSuccess'],
        ...
        payload = json['payload'] != null ? MsalMobileAuthenticationResultPayload.fromJson((json['payload'] as Map<String, dynamic>)) : null,
        exception = json['exception'] != null ? MsalMobileException.fromJson((json['exception'] as Map<String, dynamic>)) : null,
        innerException = json['innerException'] != null ? MsalMobileException.fromJson((json['innerException'] as Map<String, dynamic>)) : null;
}
