...
class MsalMobile {
  ...
  static Future<MsalMobile> create(String configFilePath, String authority) async {
    ...
    if (configFilePath == null || configFilePath.length < 1) {
      throw MsalMobileException.fromErrorCode(MsalMobileExceptionErrorCode.configRequired);
    }
    try {
  ...
  Future<bool> getSignedIn() async {
    if (!initialized) {
      throw MsalMobileException.fromErrorCode(MsalMobileExceptionErrorCode.notInitialized);
    }
  ...
  Future<MsalMobileGetAccountResultPayload> getAccount() async {
    ...
    final result = response != null ? MsalMobileGetAccountResult.fromJson(jsonDecode(response)) : null;
    if (!result.isSuccess && result.exception != null) {
      throw MsalMobileException.copy(result.exception, result.innerException);
    }
  ...
  Future<MsalMobileAuthenticationResultPayload> signIn(String loginHint, List<String> scopes) async {
    if (!initialized) {
      throw MsalMobileException.fromErrorCode(MsalMobileExceptionErrorCode.notInitialized);
    }
    ...
    final result = response != null ? MsalMobileAuthenticationResult.fromJson(jsonDecode(response)) : null;
    if (!result.isSuccess && result.exception != null) {
      ...
      if (signedIn) {
        throw MsalMobileException.fromErrorCode(MsalMobileExceptionErrorCode.alreadySignedIn);
      }
      throw MsalMobileException.copy(result.exception, result.innerException);
    }
    return result.payload;
  ...
  Future<MsalMobileAuthenticationResultPayload> acquireTokenInteractive(List<String> scopes) async {
    if (!initialized) {
      throw MsalMobileException.fromErrorCode(MsalMobileExceptionErrorCode.notInitialized);
    }
  ...
  Future<MsalMobileAuthenticationResultPayload> acquireTokenSilent(List<String> scopes, String authority) async {
    if (!initialized) {
      throw MsalMobileException.fromErrorCode(MsalMobileExceptionErrorCode.notInitialized);
    }
  ...
  Future<MsalMobileAuthenticationResultPayload> acquireToken(List<String> scopes, String authority) async {
    if (!initialized) {
      throw MsalMobileException.fromErrorCode(MsalMobileExceptionErrorCode.notInitialized);
    }
    ...
    final silentResult = silentResponse != null ? MsalMobileAuthenticationResult.fromJson(jsonDecode(silentResponse)) : null;
    if (!silentResult.isSuccess && silentResult.isUiRequired) {
      ...
      final interactiveResult = interactiveResponse != null ? MsalMobileAuthenticationResult.fromJson(jsonDecode(interactiveResponse)) : null;
      if (!interactiveResult.isSuccess && interactiveResult.exception != null) {
        throw MsalMobileException.copy(interactiveResult.exception, interactiveResult.innerException);
      }
      return interactiveResult.payload;
    } else if (!silentResult.isSuccess && silentResult.exception != null) {
      throw MsalMobileException.copy(silentResult.exception, silentResult.innerException);
    }
